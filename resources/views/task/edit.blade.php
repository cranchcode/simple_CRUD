			...
			<div class="input-container">
				<div class="row">
					<span class="req-input valid" >
						...
						<input name="taskName" type="text" data-min-length="8" placeholder="Post Title" value="{{ $task->name }}">
					</span>
				</div>
			
				<div class="row submit-row">
                    <button type="submit" class="btn btn-block submit-form valid">Edit</button>
				</div>
			</div>
			</div>
			</form>
